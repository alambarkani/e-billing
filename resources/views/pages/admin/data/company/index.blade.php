                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @if ($company)
                                <tr class="border-b">
                                    <td class="px-4 py-3">
                                        <a href="{{ route('superadmin.companies.edit', ['company' => $company->id]) }}"
                                    ...
                                    <td class="px-4 py-3"><img src="{{ asset('storage/' . $company->logo) }}"
                                            alt="Company Logo"></td>
                            ...
                            @else
                                <td class="px-4 py-3 text-center" colspan="6">
                                    ...
                                    <div
                                        ...
                                        <a type="button" href="{{ route('superadmin.companies.create') }}"
