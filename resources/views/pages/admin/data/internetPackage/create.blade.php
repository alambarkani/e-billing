...
@section('content')
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            @endif
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambahkan Paket Baru</h2>
            <form action="{{ route('admin.datas.internetpackage.store') }}" method="POST"
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <textarea type="text" name="name" id="name" required
                            ...
                            placeholder="Nama Paket"></textarea>
                        @error('name')
                            <div>{{ $message }}</div>
                        @enderror
                    </div>
