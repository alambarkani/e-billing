    ...
    <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg mt-14">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
            ...
            <div
                ...
                <p class="mb-3 font-normal text-gray-200">Wa Gateway Connection</p>
                <a href="{{ route('superadmin.wagw.conn') }}"
            ...
            <div
                ...
                <p class="mb-3 font-normal text-gray-200">Pesan Notifikasi</p>
            ...
            <div
                ...
                <p class="mb-3 font-normal text-gray-200">Kirim Pesan</p>
                <a href="{{ route('admin.messages.sendPage') }}"
                    class="inline-flex justify-center items-center px-3 py-2 mt-6 text-sm font-medium text-center text-white bg-green-600 rounded-br-lg rounded-bl-lg hover:bg-green-800 focus:ring-2 focus:outline-none focus:ring-green-300">
                    Selengkapnya
                    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                        fill="none" viewBox="0 0 14 10">
