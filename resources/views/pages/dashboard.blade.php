        ...
        <div class="p-4 border-2 border-gray-200 border-dashed rounded-lg mt-14">
            <div class="grid grid-cols-3 gap-4 mb-4">
                ...
                <div
                    ...
                    <a href="#"
                        class="inline-flex justify-center items-center px-3 py-2 mt-6 text-sm font-medium text-center text-white bg-green-600 rounded-br-lg rounded-bl-lg hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300">
                        Selengkapnya
